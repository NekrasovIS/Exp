...
UI — сайдбар слева (список сообществ сверху, список каналов выбранного
сообщества снизу; «+» создаёт новое, правый клик по элементу —
переименовать/удалить/войти), клик по каналу открывает чат в основном
...
Screen Capture) слева. Тёмная тема в стиле Discord (`src/ui/Theme.h`).

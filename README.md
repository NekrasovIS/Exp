...
Сообщения показываются не плоским логом, а списком с аватаром
(инициал автора на зелёном фоне), именем и временем; подряд идущие
сообщения одного автора в пределах нескольких минут группируются —
аватар/имя/время показываются один раз на группу.

...
(круглые аватарки — первая буква названия, только те, в которых уже
состоит вошедший пользователь; «+» снизу открывает окно подключения —
вступить по коду приглашения или создать новое, — правый клик по
аватарке копирует код приглашения, для владельца ещё и перевыпускает
его/переименовывает/удаляет) и список

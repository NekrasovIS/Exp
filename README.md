...
Раскладка главного окна — по мотивам Discord (расположение/форма
компонентов, не цвета — акцент остаётся зелёным градиентом,
`src/ui/Theme.h`): слева сайдбар из двух колонок — узкая иконочная
...
выбранного сообщества (`MemberListPanel`, 240px). Сообщение

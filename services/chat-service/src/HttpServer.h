 ...
 *        moderator management (issue #114), message history, and
 *        attachment upload/download (issue #116). Every route requires
 *        a valid `Authorization: Bearer <token>` header, checked against
